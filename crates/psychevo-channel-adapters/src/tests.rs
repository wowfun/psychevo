...
use super::feishu_lark::feishu_event_to_inbound;
#[cfg(any(feature = "telegram", feature = "wechat"))]
use super::im::ImAdapter;
#[cfg(feature = "wechat")]
use super::im::ImAttachment;
#[cfg(feature = "telegram")]
use super::telegram::telegram_update_to_message;
#[cfg(feature = "wechat")]
use super::wechat::{
    WECHAT_CHANNEL_VERSION, WECHAT_ILINK_APP_ID, WECHAT_SESSION_EXPIRED_ERRCODE,
    check_wechat_ilink_health, is_wechat_ilink_session_expired_error, render_wechat_qr_terminal,
    wechat_ilink_error_code_from_message, wechat_message_to_inbound,
};
#[cfg(feature = "feishu-lark")]
use super::{FeishuLarkDomain, FeishuLarkLongConnectionConfig};
#[cfg(feature = "telegram")]
use super::{TelegramPollingAdapter, TelegramPollingConfig};
#[cfg(feature = "wechat")]
use super::{WechatIlinkAdapter, WechatIlinkConfig};
...
#[test]
#[cfg(feature = "wechat")]
fn wechat_terminal_qr_is_dense_and_quiet_zoned() {
    let rendered = render_wechat_qr_terminal("https://qr.example/wechat").expect("terminal QR");
