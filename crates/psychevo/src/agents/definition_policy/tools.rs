...
use super::super::catalog_surface::{AgentToolContext, MAX_AGENT_SPAWN_DEPTH_CAP};
use super::super::child_runs::{SpawnAgentArgs, spawn_subagent};

pub(in crate::agents) struct SpawnAgentTool {
    pub(in crate::agents) context: AgentToolContext,
}

impl SpawnAgentTool {
    pub(in crate::agents) fn new(context: AgentToolContext) -> Self {
        Self { context }
    }
}

pub(in crate::agents) struct HookedTool {
    pub(in crate::agents) inner: Arc<dyn ToolBinding>,
    pub(in crate::agents) hook_runtime: crate::hooks::HookRuntime,
}
