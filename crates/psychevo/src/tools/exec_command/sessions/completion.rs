...
use super::super::process::{remove_exec_session, session_result_json};
use super::session_manager::ExecSession;
...
mod tests {
    ...
    use super::super::session_manager::{exec_command_tool_impl_with_context, test_exec_env};
    use crate::tools::ToolRuntimeContext;
    use crate::types::{RunMode, WorkspaceMutation, WorkspaceMutationSink};
    ...
    fn subprocess_path_prepends_prefixes_to_runtime_env_path() {
        ...
        let env = BTreeMap::from([("PATH".to_string(), inherited.to_string_lossy().to_string())]);
    ...
    fn exec_output_decodes_utf8_and_windows_gbk_bytes() {
        ...
        assert_eq!(
            crate::process_env::decode_process_output_for_platform(&[0xD6, 0xD0, 0xCE, 0xC4], true),
            "中文"
        );
    }
    ...
    fn exec_output_invalid_bytes_fall_back_to_lossy_text() {
        let output = crate::process_env::decode_process_output_for_platform(&[0xFF, 0xFF], true);
