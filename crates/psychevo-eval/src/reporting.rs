...
.panel,.trace-panel{padding:18px}.trace-panel{margin-top:18px}.panel-head,.trace-head{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:start;margin-bottom:14px}.trace-title{display:flex;align-items:baseline;gap:10px;flex-wrap:wrap}.trace-title code{font:700 22px/1 var(--mono);color:var(--ink);overflow-wrap:anywhere}.trial-switcher{display:flex;align-items:center;justify-content:flex-end;gap:7px;flex-wrap:wrap;max-width:420px}.trial-switch{min-height:32px;border:1px solid color-mix(in oklch,var(--rule),transparent 20%);border-radius:999px;background:var(--surface);color:var(--ink);display:inline-flex;align-items:center;gap:6px;padding:0 10px;font:700 11px/1 var(--mono);box-shadow:0 5px 12px rgba(49,42,25,.10)}.trial-switch:hover{background:var(--surface-2);border-color:color-mix(in oklch,var(--focus),transparent 55%)}.trial-switch.active{background:var(--focus);border-color:var(--focus);color:var(--surface);box-shadow:0 7px 16px rgba(36,62,98,.20)}.trial-switch em{font-style:normal;color:inherit;opacity:.72;text-transform:uppercase;font-size:9px;letter-spacing:.05em}.metric-controls{display:flex;align-items:center;gap:8px}.segmented{display:inline-flex;background:var(--surface-2);border-radius:999px;padding:4px;box-shadow:inset 0 0 0 1px rgba(51,44,27,.08)}.metric-button{border:0;min-height:32px;border-radius:999px;background:transparent;color:var(--muted);padding:0 11px;font:700 12px/1 var(--mono);white-space:nowrap}.metric-button.active{background:var(--surface);color:var(--ink);box-shadow:0 1px 3px rgba(49,42,25,.12)}
...
.trace-meta,.refs{display:flex;flex-wrap:wrap;gap:8px;margin-top:10px}.refs{margin:12px 0 18px}.stamp,.chip,.ref-token{display:inline-flex;align-items:center;min-height:24px;border-radius:999px;padding:0 9px;background:var(--surface-2);color:var(--muted);font:700 11px/1 var(--mono);white-space:nowrap}.tool-name-chip{gap:6px;background:oklch(91% .034 205);color:oklch(31% .070 220);box-shadow:0 4px 10px rgba(36,88,125,.14)}.tool-name-chip.tool-error-chip{color:oklch(33% .126 31);background:oklch(92% .039 31);box-shadow:0 4px 10px rgba(146,54,34,.16)}.tool-exec-inline{color:oklch(24% .032 82);font-variant-numeric:tabular-nums}.tool-error-chip .tool-exec-inline{color:oklch(34% .118 31)}.stamp.passed{color:oklch(30% .092 151);background:oklch(91% .035 151)}.stamp.failed{color:oklch(33% .126 31);background:oklch(92% .039 31)}.stamp.timeout{color:oklch(34% .080 76);background:oklch(92% .043 76)}
...
@media(max-width:980px){.main{padding:18px}.topline{grid-template-columns:1fr}.top-actions{justify-items:stretch}.score-strip{grid-template-columns:repeat(3,minmax(0,1fr))}.serve-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr))}.info-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:620px){h1{font-size:30px}.segmented{overflow-x:auto;max-width:100%}.panel-head,.trace-head,.step>summary{grid-template-columns:1fr}.step-row{grid-template-columns:44px 68px minmax(0,1fr)}.preview{white-space:normal}.rail{width:100%;justify-items:start}.rail-summary,.rail-tool-row,.rail-time{justify-content:flex-start}.info-grid{grid-template-columns:1fr}.leader-entry>summary{grid-template-columns:1fr}.serve-actions{grid-template-columns:1fr}}
</style>"#
}
