...
.trace-meta,.refs{display:flex;flex-wrap:wrap;gap:8px;margin-top:10px}.refs{margin:12px 0 18px}.stamp,.chip,.ref-token{display:inline-flex;align-items:center;min-height:24px;border-radius:999px;padding:0 9px;background:var(--surface-2);color:var(--muted);font:700 11px/1 var(--mono);white-space:nowrap}.stamp.passed{color:oklch(30% .092 151);background:oklch(91% .035 151)}.stamp.failed{color:oklch(33% .126 31);background:oklch(92% .039 31)}.stamp.timeout{color:oklch(34% .080 76);background:oklch(92% .043 76)}
...
.step-list{display:grid;gap:8px;margin-top:12px}.step{border:1px solid var(--rule);border-radius:var(--radius);background:color-mix(in oklch,var(--surface),var(--surface-2) 26%);overflow:hidden}.step[open],.step.selected-step{background:var(--surface);box-shadow:0 8px 20px rgba(49,42,25,.08)}.step>summary{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:14px;align-items:center;min-height:64px;padding:12px;cursor:pointer;list-style:none}.step>summary::-webkit-details-marker{display:none}.step-row{display:grid;grid-template-columns:48px 74px minmax(0,1fr);gap:10px;align-items:center;min-width:0}.step-id,.role{font:700 11px/1 var(--mono);white-space:nowrap}.step-id{color:var(--muted)}.role{border-radius:999px;min-height:24px;display:inline-flex;align-items:center;justify-content:center;background:var(--surface-2);color:var(--muted);text-transform:uppercase}.role.system{color:oklch(34% .065 285);background:oklch(91% .030 285)}.role.user{color:oklch(32% .063 219);background:oklch(91% .030 219)}.role.agent{color:oklch(29% .084 151);background:oklch(91% .035 151)}.preview{min-width:0;font-size:13px;line-height:1.35;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.rail{display:grid;grid-template-columns:repeat(4,auto);gap:6px;justify-content:end;color:var(--muted);font:11px/1 var(--mono);white-space:nowrap}.rail:empty{display:none}.step-body{border-top:1px solid var(--rule);padding:12px;display:grid;gap:10px}
