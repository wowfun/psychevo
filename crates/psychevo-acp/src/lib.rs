...
pub(crate) use agent_client_protocol::schema::{
    ...
    ConfigOptionUpdate, ContentBlock, ContentChunk, CurrentModeUpdate, Diff as AcpDiff,
...
pub(crate) use psychevo_runtime::{
    ...
    WorkspaceDiff, WorkspaceDiffFile, append_local_permission_rule, canonicalize_workdir,
