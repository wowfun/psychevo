...
pub(crate) struct GatewaySetupArgs {
    ...
    #[arg(long, value_name = "ID", help = "Connection id; defaults to the channel")]
    ...
    #[arg(long, conflicts_with = "disable", help = "Enable the channel after setup")]
    pub(crate) enable: bool,
    #[arg(long, conflicts_with = "enable", help = "Disable the channel after setup")]
    pub(crate) disable: bool,
    #[arg(long, conflicts_with = "restart", help = "Start the managed Gateway after setup")]
    pub(crate) start: bool,
    #[arg(long, conflicts_with = "start", help = "Restart the managed Gateway after setup")]
