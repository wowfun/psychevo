...
pub(crate) fn slash_completion_with_items(input: &str, items: &[SlashMenuItem]) -> Option<String> {
    if input.contains('\n') {
        return None;
    }
...
pub(crate) fn selected_slash_menu_command_with_items(
    input: &str,
...
pub(crate) struct ShellEscapeInput {
    pub(crate) command: String,
    pub(crate) history_text: String,
}

pub(crate) fn parse_shell_escape_input(input: &str) -> Option<ShellEscapeInput> {
...
pub(crate) fn is_empty_shell_escape_input(input: &str) -> bool {
