...
struct FullscreenUi<'a> {
    ...
    live_tool_args: BTreeMap<String, Value>,
    clarify_tool_args: BTreeMap<String, Value>,
    exec_session_rows: BTreeMap<u64, usize>,
    exec_session_elapsed: BTreeMap<u64, Duration>,
    shell_mode: bool,
    ...
    turn_session_id: Option<String>,
    active_event_session_id: Option<String>,
    turn_failures: usize,
