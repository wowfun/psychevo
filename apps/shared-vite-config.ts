...
type SharedViteBuildOptions = {
  includeFloatingApp?: boolean;
  includePreloadHelper?: boolean;
  includeYaml?: boolean;
};
...
export function sharedViteBuildConfig(options: SharedViteBuildOptions = {}) {
  const groups: ChunkGroup[] = [];
  if (options.includePreloadHelper) {
    groups.push({
  ...
  groups.push(
    ...
    },
    {
      ...
      priority: 99,
      test: (id) => includesNodePackage(normalizedModuleId(id), "@mermaid-js/parser")
    },
    {
    ...
    },
    {
      ...
      priority: 97,
      test: (id) => includesNodePackage(normalizedModuleId(id), "cytoscape")
    },
    {
      name: "vendor-mermaid-math",
      priority: 96,
      test: (id) => includesNodePackage(normalizedModuleId(id), "katex")
    },
    {
  ...
  groups.push(
    { name: "vendor-markdown", priority: 85, test: isMarkdownVendor },
    {
      name: "vendor-icons",
      priority: 80,
