...
export function observabilityResult(threadId: string | null, peer = false): Record<string, unknown> {
  ...
  return {
    context: {
      ...
      basis: hasThread ? (peer ? "agent_reported_context" : "latest_provider_turn") : "unavailable",
      appliesToSessionSeq: hasThread && !peer ? 2 : null,
    ...
    usage: {
      ...
      effectiveTotalTokens: hasThread ? (peer ? 8_000 : 250) : null,
