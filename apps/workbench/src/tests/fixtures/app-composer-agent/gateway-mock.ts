...
const gatewayMock = vi.hoisted(() => {
  ...
  return {
    ...
    extensionAppOpen: null as null | ((params: unknown) => unknown | Promise<unknown>),
    threadInteractionRespond: (() => ({
      accepted: true,
      interactionId: "interaction-1",
      outcome: "accepted"
    })) as (params: unknown) => unknown | Promise<unknown>,
    ...
    pluginInspectionResult: null as Record<string, unknown> | null,
    extensionRecords: [
      {
    ...
    teamRecords: [] as Array<Record<string, unknown>>,
    shadowedTeamRecords: [] as Array<Record<string, unknown>>,
