...
import { clientRequestThreadDraftOpenSchema } from './rpc/client-request/thread-draft-open';
...
export const rpcSchemas = {
  ...
  "oneOf": [
    ...
    {
      "$ref": "ClientRequest/thread-draft-open.json"
    },
    {
    ...
    {
      "$ref": "ClientRequest/plugin-catalog-upgrade.json"
    },
    {
      "$ref": "ClientRequest/plugin-connect-start.json"
    },
    {
...
export const rpcSchemaRefs = [
  ...
  clientRequestThreadDraftOpenSchema,
