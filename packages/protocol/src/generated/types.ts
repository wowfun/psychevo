...
export type AutomationScheduleInput = { "kind": "interval", everyMinutes: number, } | { "kind": "daily", time: string, } | { "kind": "weekly", weekdays: Array<number>, time: string, };
...
export type AutomationDraftView = { target: AutomationTargetInput, title: string, prompt: string, schedule: AutomationScheduleInput, enabled: boolean, execution: AutomationExecutionInput, model: string | null, reasoningEffort: string | null, };

export type AutomationWriteParams = { automationId: string | null, scope: GatewayRequestScope | null, target: AutomationTargetInput, title: string, prompt: string, schedule: AutomationScheduleInput, enabled: boolean | null, execution: AutomationExecutionInput | null, model: string | null, reasoningEffort: string | null, };
