...
export type PluginInstallParams = { source: string, gitRef: string | null, scopeName: string | null, force: boolean, scope: GatewayRequestScope | null, };
