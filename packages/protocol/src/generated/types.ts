...
export type JsonSafeI64 = number;
...
export type ExtensionListParams = { scope?: GatewayRequestScope | null, };

export type ExtensionReadParams = { selector: string, scopeName?: string | null, scope?: GatewayRequestScope | null, };

export type ExtensionRemoveParams = { selector: string, scopeName?: string | null, scope?: GatewayRequestScope | null, };

export type ExtensionSetEnabledParams = { selector: string, enabled: boolean, scopeName?: string | null, scope?: GatewayRequestScope | null, };

export type ExtensionAppOpenParams = { selector: string, appId: string, scopeName?: string | null, scope?: GatewayRequestScope | null, };

export type ExtensionAppCloseParams = { leaseId: string, scope?: GatewayRequestScope | null, };
...
export type PluginDoctorEntryView = { plugin: PluginView, manifest: unknown, inspection: unknown, };

export type PluginDoctorResult = { plugins: Array<PluginDoctorEntryView>, apps?: unknown, };

export type ExtensionView = { id: string, selector: string, version: string, displayName?: string | null, description?: string | null, source: string, sourceKind: string, scope: string, enabled: boolean, trusted: boolean, fingerprint: string, trustedFingerprint: string, protocol: string, protocolCompatible: boolean, permissions?: Array<string>, sidecarState: string, leaseReason?: string | null, cspAppReadiness: string, coRootPlugin?: string | null, diagnostics?: Array<string>, };

export type ExtensionListResult = { extensions: Array<ExtensionView>, count: number, };

export type ExtensionReadResult = { extension: ExtensionView, manifest: unknown, };

export type ExtensionMutationResult = { success: boolean, id: string, scope: string, enabled?: boolean | null, };

export type ExtensionAppOpenResult = { leaseId: string, extensionId: string, appId: string, resourceUri: string, resourceUrl: string, resourceDomains: Array<string>, connectDomains: Array<string>, allowedTools: Array<string>, fallback: string, };

export type ExtensionAppCloseResult = { released: boolean, };
