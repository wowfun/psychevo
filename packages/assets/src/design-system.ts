// Generated from specs/075-design-system/DESIGN.md. Do not edit directly.
export const pevoAppearances = [
  "dark",
  "light",
  "warm"
] as const;
...
export const psychevoDesignSystem = {
  "version": "alpha",
  ...
  "tokens": {
    ...
    "components": {
      "transcript-user-prompt": {
        "backgroundColor": "oklch(12.8% 0.006 85)",
        "textColor": "oklch(95.5% 0.012 84)",
        "typography": {
          "fontFamily": "Ubuntu Sans",
          "fontSize": "15px",
          "fontWeight": 400,
